...
- **CSS3: **Para todo el estilizado, diseño responsive, animaciones y simulación de interacciones.
  ...
  - **Pseudoclases y Selectores Avanzados:** Para simular interactividad sin necesidad de JavaScript (`:hover`, `:checked`, `~`, `:target`).
...
- **Nombre:** Santiago Suarez Hernadez / Juan Angel Mantilla
- **GitHub:** Suarez-26 / jotaa-a